...
function () {
  ...
  _createClass(Content, [{
    ...
    value: function editMessage(e) {
      ...
      var fn = function (data) {
        ...
        if (this.inDocForm) this.inDocForm.setDocform({
          id: id,
          title: title,
          text: text,
          price: price,
        ...
        });else this.inDocForm = new _docform_Docform__WEBPACK_IMPORTED_MODULE_2__["default"]({
          id: id,
          title: title,
          text: text,
          price: price,
      ...
      this.getJson("doc/".concat(msg.children[0].innerText), fn);
    }
  }, {
    key: "changeContent",
    ...
    key: "getDocs",
    value: function getDocs(page, find, place, mylots) {
              ...
              case 0:
                ...
                return fetch(url).then(function (response) {
                  return response.json().then(function (data) {
                    ...
                    fn(res.data); // console.log(res.status, res.data);
                  });
                });
  ...
  return Content;
}(), (_applyDecoratedDescriptor(_class.prototype, "editMessage", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "editMessage"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "changeContent", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "changeContent"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "clickPage", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "clickPage"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "getPage", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "getPage"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "getDocs", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "getDocs"), _class.prototype)), _class);
...
function () {
  ...
  _createClass(Docform, [{
    key: "setDocform",
    value: function setDocform(_ref2) {
      var id = _ref2.id,
          title = _ref2.title,
          text = _ref2.text,
          price = _ref2.price,
          place = _ref2.place,
          imgFileIds = _ref2.imgFileIds;
      this.id = id;
      this.title.value = title;
      this.text.value = text;
      this.price.value = price;
    ...
    key: "getIdFromSrc",
    value: function getIdFromSrc(img) {
      var arr = img.src.split('/');
      return arr[arr.length - 1];
    }
  }, {
    key: "clickSbmt",
    value: function clickSbmt() {
      var _this = this;

      var imgs = this.images.querySelectorAll('.docform__image');
      var count = 0; //delete from minus

      if (this.images.idToDelete) {
        this.images.idToDelete.forEach(function (id) {
          _this.deleteFile(id);

          _this.imgFileIds.splice(_this.imgFileIds.indexOf(id), 1);
        });
        delete this.images.idToDelete; // count--;
      }

      var _loop = function _loop(i) {
        //delete when replace
        if (imgs[i].idToDelete) {
          _this.deleteFile(imgs[i].idToDelete);

          delete imgs[i].idToDelete;
        } //save new images files


        if (!_this.imgFileIds.includes(_this.getIdFromSrc(imgs[i]))) {
          fn = function (text) {
            if (text != "noimage") {
    ...
    value: function sendForm() {
      var fn = function (text) {
        this.sbmt.dispatchEvent(new Event('goHome', {
          bubbles: true,
          cancelable: true
        }));
        alert(text);
    ...
    value: function drawImages() {
      ...
      this.imgFileIds.forEach(function (id) {
        _this2.drawImg("image/".concat(id), null);
      });
    }
  }, {
    key: "clickImage",
    value: function clickImage(e) {
      ...
      input.onchange = function (e) {
        ...
        reader.onload = function (readerEvent) {
          ...
          if (replace) {
            if (!_this3.img.idToDelete) _this3.img.idToDelete = _this3.getIdFromSrc(_this3.img);
            _this3.img.src = content;
            _this3.img.file = file;
          } else {
            _this3.drawImg(content, file);
          }
        };
      };
    ...
    value: function saveFile(file, fn) {
      ...
      fetch("image", {
        ...
        if (response.status == "200") return response.text();else return "noimage";
      }).then(function (text) {
        fn(text);
      });
    }
  ...
  return Docform;
}(), (_applyDecoratedDescriptor(_class.prototype, "setDocform", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "setDocform"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "clickSbmt", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "clickSbmt"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "sendForm", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "sendForm"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "drawImages", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "drawImages"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "clickImage", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "clickImage"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "saveFile", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "saveFile"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "deleteFile", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "deleteFile"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "drawImg", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "drawImg"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "addMinus", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "addMinus"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "addPlus", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "addPlus"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "removeImg", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "removeImg"), _class.prototype)), _class);
...
/* harmony import */ var _search_Search__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../search/Search */ "./src/search/Search.js");
var _class;
...
function () {
  function Menu() {
    ...
    if (searchElement) {
      this.search = new _search_Search__WEBPACK_IMPORTED_MODULE_3__["default"](searchElement);
    }
  ...
  return Menu;
}(), (_applyDecoratedDescriptor(_class.prototype, "goHome", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "goHome"), _class.prototype)), _class);
...
function () {
  ...
  _createClass(Message, [{
    ...
    value: function editMessage() {
      this.element.dispatchEvent(new Event("editMessage", {
        bubbles: true,
        cancelable: true
      }));
    }
    ...
    value: function deleteMessage() {
      if (confirm('Are you sure you want to delete this document?')) {
        for (var i = 0; i < this.imgFileIds.length; i++) {
          this.deleteFile(this.imgFileIds[i]);
        }

        fetch("doc/".concat(this.id.innerText), {
          method: "DELETE"
        }).then(function (response) {
          return response.text().then(function (text) {
            console.log(text);
        ...
        this.element.dispatchEvent(new Event('goHome', {
          bubbles: true,
          cancelable: true
        }));
      } else {// console.log('no');
    ...
    value: function getPhone() {
      ...
      fetch("account/".concat(this.email.replace(".", "((at))")), {
        method: "GET"
      }).then(function (response) {
        if (response.status == 404) {
          return {
            phone: "Only users can see the phone number."
          };
        }

        return response.json();
      }).then(function (data) {
        _this.phone.textContent = data.phone;
      });
    }
  }, {
    key: "setTitle",
              ...
              case 0:
                ...
                return fetch(url).then(function (response) {
                  response.arrayBuffer().then(function (buffer) {
                    ...
                    var imageStr = _this2.arrayBufferToBase64(buffer);
    ...
    value: function showPrev() {
      for (var i = 0; i < this.smalls.length; i++) {
        if (this.smalls[i].src == this.bigimage.src) {
          var smallTmp;
          if (i == 0) smallTmp = this.smalls[this.smalls.length - 1];else smallTmp = this.smalls[i - 1];
    ...
    value: function showNext() {
      for (var i = this.smalls.length - 1; i > -1; i--) {
        if (this.smalls[i].src == this.bigimage.src) {
          var smallTmp;
          if (i == this.smalls.length - 1) smallTmp = this.smalls[0];else smallTmp = this.smalls[i + 1];
          this.bigimage.src = smallTmp.src;
          return;
        }
      }
  ...
  return Message;
}(), (_applyDecoratedDescriptor(_class.prototype, "setEdit", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "setEdit"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "editMessage", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "editMessage"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "deleteMessage", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "deleteMessage"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "deleteFile", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "deleteFile"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "setId", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "setId"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "setPhone", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "setPhone"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "getPhone", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "getPhone"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "setTitle", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "setTitle"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "setText", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "setText"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "setDate", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "setDate"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "setPlace", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "setPlace"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "setPrice", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "setPrice"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "setImage", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "setImage"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "setActiveImage", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "setActiveImage"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "openModalImage", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "openModalImage"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "closeModal", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "closeModal"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "createBigImage", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "createBigImage"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "showPrev", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "showPrev"), _class.prototype), _applyDecoratedDescriptor(_class.prototype, "showNext", [decko__WEBPACK_IMPORTED_MODULE_0__["bind"]], Object.getOwnPropertyDescriptor(_class.prototype, "showNext"), _class.prototype)), _class);
...
function () {
  function Search(element) {
    ...
    }.bind(this)); // this.button.addEventListener('click', this.clickBtnSearch);
  }
